    ...
    componentDidMount(){
        ...
        return(
            ...
            <div className="abt-me" ref={el => this.abtme = el}>
                ...
                A self-taught developer with 1+ years of non-organizational experience 
                and 4 months of organizational experience in software development.I've also acquired a Master's Degree in the
